...
@section('content')
    ...
    <div class="row">
      ...
      <div class="panel-body">
        <form role="form" action="{{ route('author.import') }}" method="post" enctype="multipart/form-data">
          @csrf
    ...
    <div class="tile">
      ...
      <div class="panel-heading"><h3 class="panel-title text-white">Dps Import
        <a href="{{ route('author.export') }}" class="pull-right btn btn-danger btn-sm">Download Xlsx</a></h3>
      </div>
  </div>
      </div>
