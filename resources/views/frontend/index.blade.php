...
<!-- Mirrored from thegenius.co/html/loanplus/preview/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Jun 2022 19:22:39 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="logo-right-address">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="sitelogo">
                            <a href="index-2.html"><img src="{{('frontend')}}/assets/img/logo.png" alt="" /></a>
                        </div>
                    </div>
                    <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-header-bottom">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/clock.png" alt="" />
                        </div>
                        <div class="content">
                            <p>Quick & Easy Loan
                                <br> Approvals
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-header-bottom">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/user.png" alt="" />
                        </div>
                        <div class="content">
                            <p>5,000K Customers
                                <br> Satisfied
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-header-bottom">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/camera.png" alt="" />
                        </div>
                        <div class="content">
                            <p>No Prepayment or
                                <br> Hidden Fees</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-header-bottom">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/map-pin-2.png" alt="" />
                        </div>
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-featured">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/icon-1.png" alt="" />
                        </div>
                        <div class="content">
                            <h4>DPS</h4>
                            <p>DPS</p>
                            <a href="{{url('dps')}}">READ MORE <i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-featured">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/car.png" alt="" />
                        </div>
                        <div class="content">
                            <h4>Car Loan</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-featured">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/home.png" alt="" />
                        </div>
                        <div class="content">
                            <h4>Business Loan</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-featured">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/education.png" alt="" />
                        </div>
                        <div class="content">
                            <h4>Home Loan</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-featured">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/money.png" alt="" />
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-featured">
                        <div class="icon">
                            <img src="{{('frontend')}}/assets/img/card.png" alt="" />
                        </div>
                        <div class="content">
                            <h4>Payday Loan</h4>
                ...
                <div class="col-md-4">
                    <div class="single-why-choose">
                        <div class="choose-img">
                            <img src="{{('frontend')}}/assets/img/choose-1.jpg" alt="" />
                        </div>
                        <div class="choose-title">
                            <h4><img src="{{('frontend')}}/assets/img/icon-2.png" alt="">No Hidden Fees</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-why-choose">
                        <div class="choose-img">
                            <img src="{{('frontend')}}/assets/img/choose-2.jpg" alt="" />
                        </div>
                        <div class="choose-title">
                            <h4><img src="{{('frontend')}}/assets/img/icon-3.png" alt="">Less Documents</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-why-choose">
                        <div class="choose-img">
                            <img src="{{('frontend')}}/assets/img/choose-3.jpg" alt="" />
                        </div>
                        <div class="choose-title">
                            <h4><img src="{{('frontend')}}/assets/img/icon-4.png" alt="">Specialist Team</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="testimonial-slider owl-carousel">
                    <div class="single-testimonial">
                        <div class="testimonial-img">
                            <img src="{{('frontend')}}/assets/img/testimonial.jpg" alt="" />
                        </div>
                    ...
                    <div class="single-testimonial">
                        <div class="testimonial-img">
                            <img src="{{('frontend')}}/assets/img/testimonial-1.jpg" alt="" />
                        </div>
                        <div class="testimonial-content">
                            <h4>Nia Jax</h4>
                            <h5>IT Manager</h5>
                    ...
                    <div class="single-testimonial">
                        <div class="testimonial-img">
                            <img src="{{('frontend')}}/assets/img/testimonial-2.jpg" alt="" />
                        </div>
                        <div class="testimonial-content">
    ...
    <section class="map-image-section section-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="map-img">
                        <img src="{{('frontend')}}/assets/img/map.png" alt="" />
                    </div>
                </div>
                <div class="col-lg-5">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="single-article">
                        <div class="article-img">
                            <a href="##"><img src="{{('frontend')}}/assets/img/articale-1.jpg" alt="" /></a>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-article">
                        <div class="article-img">
                            <a href="##"><img src="{{('frontend')}}/assets/img/articale-2.jpg" alt="" /></a>
                            <div class="article-date">
                                <p>Mar 10, 2018</p>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-article-list">
                        <div class="article-list-img">
                            <a href="##"><img src="{{('frontend')}}/assets/img/articale-sm.jpg" alt="" /></a>
                        </div>
                    ...
                    <div class="single-article-list">
                        <div class="article-list-img">
                            <a href="##"><img src="{{('frontend')}}/assets/img/articale-sm-2.jpg" alt="" /></a>
                        </div>
                        <div class="article-list-content">
        ...
        <div class="container">
            <div class="brand-slider owl-carousel">
                <div class="single-brand">
                    <img src="{{('frontend')}}/assets/img/brand-1.png" alt="" />
                </div>
                <div class="single-brand">
                    <img src="{{('frontend')}}/assets/img/brand-2.png" alt="" />
                </div>
                <div class="single-brand">
                    <img src="{{('frontend')}}/assets/img/brand-3.png" alt="" />
                </div>
                <div class="single-brand">
                    <img src="{{('frontend')}}/assets/img/brand-4.png" alt="" />
                </div>
                <div class="single-brand">
                    <img src="{{('frontend')}}/assets/img/brand-5.png" alt="" />
                </div>
            </div>
        </div>
    </section>
...
<!-- Mirrored from thegenius.co/html/loanplus/preview/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Jun 2022 19:23:37 GMT -->
</html>