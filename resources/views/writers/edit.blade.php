                        ...
                        <div class="row">
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name_of_bank" id="bangla_name" value="{{$writers->name_of_bank}}"/>  
                                </div>
                            </div>
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="short_name" id="bangla_name" value="{{$writers->short_name}}"/>  
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="head_office_address" id="bangla_name" value="{{$writers->head_office_address}}"/>  
                                </div>
                            </div>
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="holding" id="bangla_name" value="{{$writers->holding}}"/>  
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="mobile_no" id="bangla_name" value="{{$writers->holding}}"/>  
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="email" id="bangla_name" value="{{$writers->email}}"/>  
                                </div>
                            </div>
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="contact_mobile" id="bangla_name" value="{{$writers->contact_mobile}}"/>  
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="contact_designation" id="bangla_name" value="{{$writers->contact_designation}}"/>  
                                </div>
                            </div>
